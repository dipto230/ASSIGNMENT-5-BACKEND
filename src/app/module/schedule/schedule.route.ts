...
router.get('/', checkAuth(Role.ADMIN, Role.SUPER_ADMIN, Role.LAWYER), ScheduleController.getAllSchedules);
router.get('/:id', checkAuth(Role.ADMIN, Role.SUPER_ADMIN, Role.LAWYER), ScheduleController.getScheduleById);
